...
data = pd.read_csv("./distance2.csv")
...
ax.plot(x, cls_model1, label="cls_w_review")
ax.plot(x, cls_model2, label="cls_w_review_2")
ax.plot(x, mse_1_model1, label="mse_1_w_review")
ax.plot(x, mse_1_model2, label="mse_1_w_review_2")
ax.plot(x, mse_2_model1, label="mse_2_w_review")
ax.plot(x, mse_2_model2, label="mse_2_w_review_2")
ax.plot(x, mse_3_model1, label="mse_3_w_review")
ax.plot(x, mse_3_model2, label="mse_3_w_review_2")
ax.legend()
ax = fig.add_subplot(122)
ax.plot(x, acc_model1, label="acc_w_review")
ax.plot(x, acc_model2, label="acc_w_review_2")
ax.legend()
plt.show()
