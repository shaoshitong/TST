...
path_wo_reviewkd = "/checkpoints/wrn40_2_wrn16_2_w_review/final_dataset_Original_DataLoader_C100_teacher_wrn_40_2_student_wrn_16_2.pth"
path_w_reviewkd = "/checkpoints/wrn40_2_wrn16_2_w_review_2/final_dataset_Original_DataLoader_C100_teacher_wrn_40_2_student_wrn_16_2.pth"
...
test_dataset = torchvision.datasets.cifar.CIFAR100("/home/sst/dataset/c100",train=False,transform=transforms.Compose(
            [
                transforms.ToTensor(),
...
def test(test_dataloader,model1,model2,teacher):
    ...
    result = [model1_cls_kl_list,model2_cls_kl_list,model1_acc_list,model2_acc_list,model1_f_mse_list_1,model2_f_mse_list_1,model1_f_mse_list_2,model2_f_mse_list_2,model1_f_mse_list_3,model2_f_mse_list_3]
    new_result = []
