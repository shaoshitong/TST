...
from mmseg.models.losses import cross_entropy, mask_cross_entropy, binary_cross_entropy, \
    weight_reduce_loss
...
class OSDSEGCrossEntropyLoss(CrossEntropyLoss):
    ...
    def __init__(self,
        ...
        """
        super(OSDSEGCrossEntropyLoss, self).__init__(
